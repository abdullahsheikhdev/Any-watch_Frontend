...
export default function TopBar() {
    ...
    return (
        <div className="flex justify-between items-center bg-gray-800 px-10 py-8 border-b-2 border-gray-400">
            <h1 className="text-3xl font-bold text-white"><span className='text-6xl text-[#F84565]'>A</span>ny Watch</h1>
