...
export default function TopBar() {
    ...
    return (
        <div className="flex justify-between items-center bg-[#020617] px-10 py-4 border-b-2 border-gray-400">
            <h1 className="text-3xl font-bold text-gray-400"><span className='text-5xl text-[#EAB308]'>A</span>ny Watch</h1>
