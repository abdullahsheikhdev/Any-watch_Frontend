...
import type { LoginFormData, FormErrors, AuthResponse, VerifyEmailResponse } from '@/@types/auth'
        ...
        {!showOtpInput ? (
          ...
          <>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Please enter the 6-digit verification code sent to your email.</p>
            </div>
            ...
            <form onSubmit={onSubmitOtpHandler} className="space-y-6">
              <div onPaste={handlePaste} className="flex justify-between gap-2 max-w-xs mx-auto my-6">
                {Array(6)
                  .fill(0)
                  .map((_, index) => (
                    <input
