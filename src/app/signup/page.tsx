      ...
      {otpSent && (
        ...
        >
          ...
          <p className="text-white text-sm my-2">
            Please check your email for the verification 6 digit code.
          </p>
          <div onPaste={handlePaste} className="flex justify-between mb-5">
            {Array(6)
              .fill(0)
              .map((_, index) => (
                <input
                  ...
                  type="text"
                  maxLength={1}
                  className="w-12 h-12 text-center bg-white rounded-lg text-black font-bold"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-white  cursor-pointer text-gray-400 hover:text-gray-600 mt-5 py-2 rounded-3xl font-medium"
          >
